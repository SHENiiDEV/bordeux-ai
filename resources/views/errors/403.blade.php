...
<head>
    ...
    <title>403: Restricted Member Section — Bordeux AI</title>
    ...
    <div class="glass-panel-burgundy max-w-lg w-full p-8 sm:p-12 rounded-3xl border border-[#d4af37]/30 text-center space-y-6 shadow-2xl">
        ...
        <div class="space-y-2">
            <span class="text-xs uppercase font-bold tracking-widest text-[#f3cf65] px-3 py-1 rounded bg-[#4a0e17] border border-[#d4af37]/30">
                Restricted Member Vault
            </span>
            <h1 class="font-serif-luxury text-3xl font-bold text-white">Access Privilege Required</h1>
        </div>
        <p class="text-xs text-slate-300 font-light leading-relaxed">
            Access to this section is restricted to vetted private members. Please apply or sign in to your concierge account.
        </p>
        <div>
            <a href="/membership/apply" class="inline-block px-6 py-3.5 rounded-xl bg-gradient-to-r from-[#4a0e17] to-[#6b1422] text-[#f3cf65] text-xs font-bold uppercase tracking-wider border border-[#d4af37]/40 hover:border-[#d4af37] shadow-xl">
